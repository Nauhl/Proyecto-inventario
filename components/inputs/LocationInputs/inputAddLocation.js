...
export default function AddLocation(props) {
    ...
    return (
        <div className="modal fade" id="newLocation" data-backdrop="static" data-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div className="modal-content">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input
                                type="file" name="MAX_FILE_SIZE" value="4194304"
                                size="small"
                                id="pictures-input"
                                label="Pictures"
